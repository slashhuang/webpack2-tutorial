...
```
Hash: 49a2b3b1a85f33063e81
Version: webpack 3.0.0
      Asset     Size  Chunks             Chunk Names
0.output.js  1.93 kB       0  [emitted]  
  output.js  7.43 kB       1  [emitted]  main
Entrypoint main = output.js
chunk    {0} 0.output.js 263 bytes {1} [rendered]
    > [] 4:0-16
    [3] ./lazy.js + 2 modules 221 bytes {0} [built]
        [exports: d, c, x, y]
        import() ./lazy [] ./example.js 4:0-16
     + 1 hidden module
chunk    {1} output.js (main) 367 bytes [entry] [rendered]
    > main [] 
    [0] ./node_modules/shared.js + 1 modules 100 bytes {1} [built]
        [exports: x, y]
    ...
    [1] ./example.js + 2 modules 267 bytes {1} [built]
        [no exports]
```
